						...
						<div class="tab-pane active" id="horizontal-form">
							...
							<form class="form-horizontal" role="form" id="subject_form"  method="post" action="<?=base_url()?>main/add_subject">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control1" name="subject_name" id="subject_name" placeholder="Default Input">
									</div>
								...
								<div class="form-group">
									...
									<label for="credits_to_split" class="col-sm-8 control-label">გასანაწილებელი კრედიტები</label>
										...
										<input type="text" name="credits_to_split" value="0" disabled id="credits_to_split" class="col-sm-2 bg-alert dark pv20 text-white fw600 text-center">
								...
								<div class="four-grids">
									<?php foreach ($activityes as $key => $activity):?>
										...
										<div class="col-md-3 four-grid" style="padding-bottom: 10px;">
										...
										<!-- 		<div class="icon">
												...
												<div class="four-text">
													...
													<input class="col-md-4" size="3" type="text" name="value<?=$activity->id?>" id="value<?=$activity->id?>" value='0'> 
										...
										<div class="col-md-3 four-grid">
											<div class="four-agileinfo">
												...
												<div class="four-text">
													<h5>ლექცია</h5>
													<h5> 24 </h5>
													<div id="add_lec" class="hvr-icon-float-away col-24"></div>
										...
										<div class="col-md-3 four-grid">
											<div class="four-w3ls">
												...
												<div class="four-text">
													<h5>პრაქტიკული</h5>
													<h5> 24 </h5>
													<div id="add_prac" class="hvr-icon-float-away col-24"></div>
										...
										<div class="col-md-3 four-grid">
											<div class="four-wthree">
												...
												<div class="four-text">
													<h5>ლაბორატორიული</h5>
													<h5> 24 </h5>
													<div id="add_lab" class="hvr-icon-float-away col-24"></div>
...
function add($id)
{
					...
					$('#credits_to_split').val(parseInt(oldvalue-1));
					
					var olddamo=parseInt($('#value'+$id).val());

					$('#value'+$id).val(parseInt(olddamo+1));
 ...
 -->
 								<!-- <div class="form-group mb-n">
									...
									<div class="col-sm-8 col-sm-offset-2">
										<button type="submit" class="btn-primary btn" id="save">შენახვა</button>
